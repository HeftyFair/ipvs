...
![sketch-structure](source/12.22用图/sketch.jpg)
## sketch结构
## 数据处理统计方法
  - 整个sketch只需要hash一次
    - 尽量减少hash次数
...
### top speed
![tcpreplay](source/12.22用图/topspeed.jpg)

```bash
('172.16.0.5', '192.168.50.1') 
sends:  207270
sketch_counts:  40761

('192.168.50.7', '4.2.2.4') 
sends:  76
sketch_counts:  7

('4.2.2.4', '192.168.50.7') 
sends:  78
sketch_counts:  70

('192.168.50.7', '54.218.239.186') 
sends:  16
sketch_counts:  2

('8.8.8.8', '192.168.50.7') 
sends:  30
sketch_counts:  70

('192.168.50.7', '8.8.8.8') 
sends:  28
sketch_counts:  2

('192.168.50.7', '52.35.236.192') 
sends:  18
sketch_counts:  1

('74.208.236.171', '192.168.50.7') 
sends:  54
sketch_counts:  70

('192.168.50.7', '74.208.236.171') 
sends:  40
sketch_counts:  4

('125.56.201.105', '192.168.50.7') 
sends:  4
sketch_counts:  70

('192.168.50.7', '125.56.201.105') 
sends:  2
sketch_counts:  0

('54.218.239.186', '192.168.50.7') 
sends:  12
sketch_counts:  70

('52.35.236.192', '192.168.50.7') 
sends:  13
sketch_counts:  70

('192.168.50.7', '172.217.12.130') 
sends:  168
sketch_counts:  15

('172.217.12.130', '192.168.50.7') 
sends:  186
sketch_counts:  70

('192.168.50.7', '72.21.91.29') 
sends:  16
sketch_counts:  2

('192.168.50.7', '216.58.219.193') 
sends:  72
sketch_counts:  7

('192.168.50.1', '172.16.0.5') 
sends:  38
sketch_counts:  13

('72.21.91.29', '192.168.50.7') 
sends:  12
sketch_counts:  70

('216.58.219.193', '192.168.50.7') 
sends:  78
sketch_counts:  70

('192.168.50.7', '172.217.7.14') 
sends:  40
sketch_counts:  3

('172.217.7.14', '192.168.50.7') 
sends:  28
sketch_counts:  70

('192.168.50.7', '172.217.10.4') 
sends:  44
sketch_counts:  5

('172.217.10.4', '192.168.50.7') 
sends:  44
sketch_counts:  70

('192.168.50.7', '172.217.11.34') 
sends:  48
sketch_counts:  3

('172.217.11.34', '192.168.50.7') 
sends:  47
sketch_counts:  70

('192.168.50.7', '162.248.19.151') 
sends:  16
sketch_counts:  1

('162.248.19.151', '192.168.50.7') 
sends:  19
sketch_counts:  70

('192.168.50.7', '38.69.238.19') 
sends:  8
sketch_counts:  0

('38.69.238.19', '192.168.50.7') 
sends:  6
sketch_counts:  70

('192.168.50.253', '224.0.0.5') 
sends:  4
sketch_counts:  13

('192.168.50.254', '224.0.0.5') 
sends:  3
sketch_counts:  13

('192.168.50.6', '72.21.91.29') 
sends:  4
sketch_counts:  2

('72.21.91.29', '192.168.50.6') 
sends:  4
sketch_counts:  1
```
### 1500mbps
![1500mbps](source/12.22用图/1500mbps.jpg)
```bash
('172.16.0.5', '192.168.50.1') 
sends:  207270
sketch_counts:  86389
...
```
### 1000Mbps
![1000Mbps](source/12.22用图/1000Mbps.jpg)
```bash
('172.16.0.5', '192.168.50.1') 
sends:  207270
sketch_counts:  205095
...
### 500mbps
![500Mbps](source/12.22用图/500Mbps.jpg)
```bash
('172.16.0.5', '192.168.50.1') 
sends:  207270
sketch_counts:  207276
...
## 分析
1. 首先第一个问题是发现高于1500mbps（几乎是topspeed 43%）时统计速率无法与发送速率匹配（只看第一个流，即发送数207270的攻击流就可以看出）。进一步对1000Mbps-1500Mbps进一步测试，步长为100Mbps。大概在1000Mbps是个分水岭。
    - 1100Mbps
    ```bash
    ('172.16.0.5', '192.168.50.1') 
    sends:  207270
    sketch_counts:  123021
    ``` 
    - 1200Mbps
    ```bash
    ('172.16.0.5', '192.168.50.1') 
    sends:  207270
    sketch_counts:  112511
    ```
    - 1300Mbps
    ```bash
    ('172.16.0.5', '192.168.50.1') 
    sends:  207270
    sketch_counts:  108194
    ```
    - 1400Mbps
    ```bash
    ('172.16.0.5', '192.168.50.1') 
    ...
    sketch_counts:  97558
    ```
  2. 使用identity hash和循环左移3位处理方式带来的问题。
    在srcIP不同，dstIP相同的情况下，很容易出现冲突的情况。